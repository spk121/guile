...
;; suggesting perhaps not, but the reference code shows the "list" at each
;; stage as including those elements already added.  The latter corresponds
;; to what's described for lset-union, so that's what's done.
;;
