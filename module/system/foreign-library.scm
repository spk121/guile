...
;; When loading extension "libfoo", the following should happen.
;; Standard: find libfoo.so in LTDL_LIBRARY_PATH, libdir, extensiondir
;; Darwin: find libfoo.so, libfoo.dylib, libfoo.bundle in a library directory
;; MinGW:  find libfoo.dll or libfoo-1.dll in a binary directory
;;
;; The -1 could be any integer, but in practice is < 100.
