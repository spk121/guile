...
scm_t_hash
scm_i_hash_symbol (SCM obj, scm_t_hash n, void *closure)
{
...
static SCM
lookup_interned_symbol (SCM name, scm_t_hash raw_hash)
{
...
{
  SCM symbol;
  scm_t_hash raw_hash = scm_i_string_hash (str);
